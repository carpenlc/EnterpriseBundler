...
public class URIUtils implements Serializable {
     ...
     * invoked to generate a URI with the local file system scheme.  This 
     * is a slightly different version of the getFileURI that uses the 
     * <code>Path</code> class to generate the output URI.
     * 
